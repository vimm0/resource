...
A list of practical projects that anyone can solve in any programming language (See [solutions](https://github.com/theweb_sikhalayagoel/Projects-Solutions)). These projects are divided in multiple categories, and each category has its own folder.

To get started, simply fork this repo.

## [CONTRIBUTING](https://github.com/web_sikhalayagoel/Projects/blob/master/CONTRIBUTING.md)

See ways of [contributing](https://github.com/web_sikhalayagoel/Projects/blob/master/CONTRIBUTING.md) to this repo. You can contribute **solutions** (will be published in this [repo](https://github.com/web_sikhalayagoel/Projects-Solutions)) to existing problems, **add new projects** or remove existing ones. Make sure you follow all instructions properly.


## [Solutions](https://github.com/theweb_sikhalayagoel/Projects-Solutions)

You can find implementations of these projects in many other languages by other users in [this repo](https://github.com/web_sikhalayagoel/Projects-Solutions).

## Credits

This repo was compiled by [web_sikhalaya Goel](http://twitter.com/web_sikhalaya).
...
- [Numbers](https://github.com/web_sikhalaya/Projects#numbers)
- [Classic Algorithms](https://github.com/web_sikhalaya/Projects#classic-algorithms)
- [Graph](https://github.com/web_sikhalaya/Projects#graph)
- [Data Structures](https://github.com/web_sikhalaya/Projects#data-structures)
- [Text](https://github.com/web_sikhalaya/Projects#text)
- [Networking](https://github.com/web_sikhalaya/Projects#networking)
- [Classes](https://github.com/web_sikhalaya/Projects#classes)
- [Threading](https://github.com/web_sikhalaya/Projects#threading)
- [Web](https://github.com/web_sikhalaya/Projects#web)
- [Files](https://github.com/web_sikhalaya/Projects#files)
- [Databases](https://github.com/web_sikhalaya/Projects#databases)
- [Graphics and Multimedia](https://github.com/web_sikhalaya/Projects#graphics-and-multimedia)
- [Security](https://github.com/web_sikhalaya/Projects#security)
